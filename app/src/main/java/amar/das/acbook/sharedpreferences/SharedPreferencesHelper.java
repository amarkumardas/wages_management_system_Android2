...
public class SharedPreferencesHelper {
    ...
    public enum Keys { // Enum declaration inside the class for keys
        ...
        //GOOGLE_SIGNIN_EMAIL,
        BACKUP_FILE_FOR_SHARE_TRUE_OR_DOWNLOAD_FALSE, BACKUP_EACH_FILE_USER_SELECTED_FORMAT,LAST_BACKUP_EACH_FILE,SINGLE_BACKUP_FILE_USER_SELECTED_FORMAT,LAST_SINGLE_BACKUP_FILE,LAST_DATABASE_BACKUP,
        INACTIVE_DAYS;
