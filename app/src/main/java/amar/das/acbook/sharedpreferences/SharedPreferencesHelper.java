...
public class SharedPreferencesHelper {
    ...
    public enum Keys { // Enum declaration inside the class for keys
        ...
        BACKUP_FILE_SHARE_OR_DOWNLOAD, BACKUP_EACH_FILE_USER_SELECTED_FORMAT,LAST_BACKUP_EACH_FILE,SINGLE_BACKUP_FILE_USER_SELECTED_FORMAT,LAST_SINGLE_BACKUP_FILE,LAST_DATABASE_BACKUP;
