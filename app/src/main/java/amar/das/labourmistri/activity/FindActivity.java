...
import amar.das.labourmistri.adapters.SeparateAllMLGRecordAdapter;
import amar.das.labourmistri.adapters.SearchAdapter;
import amar.das.labourmistri.globalenum.GlobalConstants;
import amar.das.labourmistri.model.MLGAllRecordModel;
import amar.das.labourmistri.model.SearchModel;
...
//        btn3.setBackgroundColor(Color.WHITE);
        ...
        btn3.setBackgroundResource(R.drawable.white_detailsbg);
        btn2.setBackgroundResource(R.drawable.white_detailsbg);
        btnData("SELECT "+Database.COL_1_ID+" , "+Database.COL_2_NAME+" , "+Database.COL_12_ACTIVE+" , "+Database.COL_15_LATESTDATE+" FROM "+Database.PERSON_REGISTERED_TABLE +" WHERE "+Database.COL_8_MAINSKILL1 +"='"+GlobalConstants.M_SKILL.getValue()+"'");
    }
...
//        btn3.setBackgroundColor(Color.WHITE);
        ...
        btnData("SELECT "+Database.COL_1_ID+" , "+Database.COL_2_NAME+" , "+Database.COL_12_ACTIVE+" , "+Database.COL_15_LATESTDATE+" FROM "+Database.PERSON_REGISTERED_TABLE +" WHERE "+Database.COL_8_MAINSKILL1 +"='"+GlobalConstants.L_SKILL.getValue()+"'");
    }
...
//        btn2.setBackgroundColor(Color.WHITE);
        ...
        btn1.setBackgroundResource(R.drawable.white_detailsbg);
        btn2.setBackgroundResource(R.drawable.white_detailsbg);
        btnData("SELECT "+Database.COL_1_ID+" , "+Database.COL_2_NAME+" , "+Database.COL_12_ACTIVE+" , "+Database.COL_15_LATESTDATE+" FROM "+Database.PERSON_REGISTERED_TABLE +" WHERE "+Database.COL_8_MAINSKILL1 +"='"+GlobalConstants.G_SKILL.getValue()+"'");
    }
