...
import amar.das.labourmistri.adapters.InactiveAdapter;
...
import amar.das.labourmistri.databinding.FragmentInactiveBinding;
       ...
       // loadDataByTakingSkillAndDefaultNoOfDataToLoadInitially('M',29);
        ...
        binding.inactiveRadiogroup.setOnCheckedChangeListener((radioGroup1, checkedIdOfRadioBtn) -> {
            if(checkedIdOfRadioBtn==R.id.mestre_total_inactive_radiogroup){
                loadDataByTakingSkillAndDefaultNoOfDataToLoadInitially(GlobalConstants.M_SKILL.getValue(),initialDataToLoad);
            } else if (checkedIdOfRadioBtn==R.id.laber_total_inactive_radiogroup) {
                loadDataByTakingSkillAndDefaultNoOfDataToLoadInitially(GlobalConstants.L_SKILL.getValue(),initialDataToLoad);
            } else if (checkedIdOfRadioBtn==R.id.g_total_inactive_radiogroup) {
                loadDataByTakingSkillAndDefaultNoOfDataToLoadInitially(GlobalConstants.G_SKILL.getValue(),initialDataToLoad);
            }
        });
