package amar.das.labourmistri.sharedpreferences;
...
public class SharedPreferencesHelper {
    ...
    public enum Keys { // Enum declaration inside the class for keys
        ...
        BUSINESS_NAME,WHATSAPP_NUMBER,PHONE_NUMBER,EMAIL,GST_NUMBER,ADDRESS,SIGNIN_SKIP_TRUE, DATA_RESTORE_INFO,
        //GOOGLE_SIGNIN_EMAIL,
        BACKUP_FILE_FOR_SHARE_TRUE_OR_DOWNLOAD_FALSE, BACKUP_EACH_FILE_USER_SELECTED_FORMAT,SINGLE_BACKUP_FILE_USER_SELECTED_FORMAT, DATE_BACKUP_EACH_FILE, DATE_SINGLE_BACKUP_FILE, DATE_DATABASE_BACKUP,
        INACTIVE_DAYS,LABOUR_DEFAULT_RATE,MISTRI_DEFAULT_RATE,WOMEN_DEFAULT_RATE
